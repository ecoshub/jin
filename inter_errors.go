...
func EMPTY_ARRAY_ERROR() 					error {return errors.New("ERROR_CODE:02 Error: Array is empty.")}
func INDEX_EXPECTED_ERROR() 				error {return errors.New("ERROR_CODE:03 Error: Index expected, got key value.")}
func KEY_EXPECTED_ERROR() 					error {return errors.New("ERROR_CODE:04 Error: Key expected, got index.")}
func OBJECT_EXPECTED_ERROR() 				error {return errors.New("ERROR_CODE:05 Error: Last path must be pointed at an object.")}
...
func PARSE_FLOAT_ERROR(val string) 			error {return errors.New(fmt.Sprintf("ERROR_CODE:13 Parse Error: '%v' Cannot be converted to float.", val))}
func PARSE_BOOL_ERROR(val string) 			error {return errors.New(fmt.Sprintf("ERROR_CODE:14 Parse Error: '%v' Cannot be converted to bool.", val))}
func PARSE_STRING_ARRAY_ERROR(val string) 	error {return errors.New(fmt.Sprintf("ERROR_CODE:15 Parse Error: '%v' Cannot be converted to []string.", val))}
